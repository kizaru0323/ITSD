...
const UserSettings = () => {
    ...
    const [profile, setProfile] = useState(() => {
        const saved = sessionStorage.getItem('itsd_user_profile');
    ...
    const showSaved = () => {
        ...
        sessionStorage.setItem('itsd_user', JSON.stringify(currentUser));
        sessionStorage.setItem('itsd_user_profile', JSON.stringify(profile));
    ...
    const handleSaveBannerName = () => {
        ...
        sessionStorage.setItem('itsd_user', JSON.stringify(currentUser));
        sessionStorage.setItem('itsd_user_profile', JSON.stringify(updatedProfile));
